...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT * FROM tickets_table WHERE voyage_id LIKE ? AND classe LIKE ?";
        ...
        mysqli_stmt_bind_param($stmt, "ii", $voyage_id, $classe);
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<h2>Ticket ID: " . htmlspecialchars($row["ticket_id"]) . "</h2>";
                ...
                echo "<button type='button' class='back-link'>Buy now</button>";
                echo "</div>";
            }
        } else {
    ...
    ?>
    <a class="back-link" href="tickets.html">Retour</a>
</div>
</body>
</html>
